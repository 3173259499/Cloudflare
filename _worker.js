...
const proxyIPs = ["test-ipv6.com"]; //ts.hpc.tw edgetunnel.anycast.eu.org bestproxy.onecf.eu.org cdn-all.xn--b6gac.eu.org cdn.xn--b6gac.eu.org proxy.xxxxxxxx.tk 85vv.cc cloudflare.com github.com test-ipv6.com 
const cn_hostnames = [''];
